...
router.get(
  ...
  asyncHandler(ctrl.listDesignations),
);
router.post(
  '/',
  requirePermission('designations.create'),
  validate(ctrl.createDesignationSchema),
  asyncHandler(ctrl.createDesignation),
);
router.get('/:id', requirePermission('designations.view'), asyncHandler(ctrl.getDesignation));
router.patch(
  '/:id',
  requirePermission('designations.update'),
  validate(ctrl.updateDesignationSchema),
  asyncHandler(ctrl.updateDesignation),
);
router.delete(
  '/:id',
  requirePermission('designations.delete'),
  asyncHandler(ctrl.deleteDesignation),
);
