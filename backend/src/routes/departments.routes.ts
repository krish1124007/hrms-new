...
router.get(
  ...
  asyncHandler(ctrl.listDepartments),
);
router.get('/tree', requirePermission('departments.view'), asyncHandler(ctrl.getDepartmentTree));
router.post(
  '/',
  requirePermission('departments.create'),
  validate(ctrl.createDepartmentSchema),
  asyncHandler(ctrl.createDepartment),
);
router.get('/:id', requirePermission('departments.view'), asyncHandler(ctrl.getDepartment));
router.patch(
  '/:id',
  requirePermission('departments.update'),
  validate(ctrl.updateDepartmentSchema),
  asyncHandler(ctrl.updateDepartment),
);
router.delete(
  '/:id',
  requirePermission('departments.delete'),
  asyncHandler(ctrl.deleteDepartment),
);
