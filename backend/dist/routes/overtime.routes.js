...
router.get('/', requirePermission('overtime.view'), validate(ctrl.listQuerySchema, 'query'), asyncHandler(ctrl.list));
...
router.post('/:id/approve', requirePermission('overtime.approve'), validate(ctrl.approveSchema), asyncHandler(ctrl.approve));
router.post('/:id/reject', requirePermission('overtime.approve'), validate(ctrl.rejectSchema), asyncHandler(ctrl.reject));
