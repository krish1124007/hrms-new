...
router.put('/schedule', validate(ctrl.updateScheduleSchema), asyncHandler(ctrl.updateSchedule));
router.post('/', validate(ctrl.createBackupSchema), asyncHandler(ctrl.createBackup));
router.post('/:id/restore', validate(ctrl.restoreBackupSchema), asyncHandler(ctrl.restoreBackup));
