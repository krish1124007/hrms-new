 ...
 */
export function compressionTelemetry(req, res, next) {
    ...
    res.end = (chunk, ...rest) => {
        ...
        const wire = parseInt(res.getHeader('content-length'), 10);
...
//# sourceMappingURL=compression-telemetry.middleware.js.map