...
export async function teamOverview(_req, res) {
    ...
    for (const m of members) {
        if (m.status === 'present')
            ...
            onLeave += 1;
        else if (m.status === 'not_checked_in')
            notCheckedIn += 1;
    }
