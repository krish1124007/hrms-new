...
export async function sendWelcomeEmail(to: string, firstName: string, tenantSlug: string): Promise<void> {
  const html = wrap(`
...
export async function sendTrialExpiringEmail(to: string, firstName: string, daysLeft: number): Promise<void> {
  const html = wrap(`
...
export async function sendPaymentFailedEmail(to: string, firstName: string, amount: number): Promise<void> {
  const html = wrap(`
...
export async function sendInvoiceEmail(to: string, firstName: string, invoiceNumber: string, pdfUrl: string, amount: number): Promise<void> {
  const html = wrap(`
...
export async function sendTicketUpdateEmail(to: string, ticketNumber: string, subject: string, agentReply: string): Promise<void> {
  const html = wrap(`
...
export async function sendAnnouncementEmail(to: string, title: string, bodyHtml: string): Promise<void> {
  const html = wrap(`
