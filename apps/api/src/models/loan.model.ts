...
export type LoanType = 'salary_advance' | 'personal_loan' | 'emergency' | 'education' | 'medical' | 'other';
...
export const Loan = model<ILoan, PaginateModel<ILoan> & Model<ILoan>>('Loan', loanSchema);
